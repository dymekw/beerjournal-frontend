...
angular.module(MODULE_NAME, [uirouter, collections, login, registration, home, allusers, navbar, authService, itemDetailsController, AddNewItemController, accountSettings, 'ngSessionStorage', 'ngMaterial','base64', 'ngRoute','ui.bootstrap','bootstrapLightbox'])
    .config(routing)
    .run(run);
